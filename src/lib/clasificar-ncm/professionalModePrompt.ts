...
- **Secado/deshidratado de alimentos (CRÍTICO):** un **deshidratador o secador de alimentos** (frutas, verduras, carnes, granos) clasifica por su FUNCIÓN (secado) en la partida **8419**, **NO en 8514** (8514 = hornos industriales de metalurgia/cerámica/tratamiento de MATERIALES). No te ancles en "horno". **Subpartida (cambia el arancel):** 8419.31 "para productos agrícolas" se reserva a secadores **industriales de campo** (granos, tabaco, forraje) → DIE 14%; un **deshidratador DOMÉSTICO / de mesada / pequeño** de frutas-verduras va a **8419.39 "los demás"** → DIE 35%. Ante duda doméstico vs industrial, preferí **8419.39** (no subcotiza) y aclará en "reason" que la subpartida 8419.31/8419.39 conviene confirmarla con el despachante.
- **Prenda completa vs partes (CRÍTICO):** una **prenda de vestir terminada** (campera, remera, pantalón, camisa, abrigo, etc.) va en su partida del **Cap. 61** (de punto) o **Cap. 62** (no de punto) según el tejido — ej. campera/anorak de hombre: **6101** (punto) o **6201** (plano); de mujer: **6102** / **6202**. **NUNCA** clasifiques una prenda completa en **6117 / 6217** (esas son SOLO "partes y complementos de vestir": cuellos, puños, etc.), ni en una subpartida de "partes". Si dudás punto/plano, elegí la partida de prenda que corresponda, no la de partes.
