...
export default function ClasificarNcmClient() {
  ...
  return (
    ...
    >
      ...
      <header className="relative z-10 flex min-h-[52px] flex-wrap items-center justify-between gap-2 border-b border-white/[0.06] px-3 py-2 pt-safe sm:min-h-0 sm:gap-3 sm:px-6 sm:py-3">
